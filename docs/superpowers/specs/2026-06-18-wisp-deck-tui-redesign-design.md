# Wisp Deck TUI Redesign — Tabbed, Polished Main Menu
...
Wisp Deck's main menu has accumulated features and now feels cramped. Four
...
```
╭ Wisp Deck ─────────────────────── ‹ Claude Code › ╮   header: brand + AI switch
